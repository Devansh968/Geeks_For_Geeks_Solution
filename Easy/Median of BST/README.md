<h2><a href="https://practice.geeksforgeeks.org/problems/median-of-bst/1?page=6&difficulty[]=0&sortBy=submissions">Median of BST</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a Binary Search Tree of size N, find the Median of its Node values.</span></p>
